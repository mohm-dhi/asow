...
for i=1:no_locs
    ...
    for p = 1:length(params)
        ...
        % do statistics
        m_scatter(wave_struct,mwd_struct,'di',[0 0.01 0.03 0.05 0.1:0.5 0.5:1 1:4]);
        cd('../../');
...
for i=1:no_locs
    ...
    for p = 1:length(params)
        ...
        % do statistics
        if p==1 || p==3
            m_scatter(wave_struct,pwd_struct,'di',[0 0.5 1:5 8 10 12 15 18]);
        elseif p==2
            m_scatter(wave_struct,pwd_struct,'di',[0 0.5 1:5 8 10]);
        end
        cd('../../');
...
for i=1:no_locs
    ...
    for p = 3%:length(params)
        ...
        % do statistics
        if p==1 || p==3
            m_scatter(wave_struct,mwd_struct,'di',[0 0.5 1:5 8:10 12]);
        elseif p==2
            m_scatter(wave_struct,mwd_struct,'di',[0 0.1 1:6]);
        elseif p==3
            m_scatter(wave_struct,mwd_struct,'di',[0 0.1 1 5 6:12]);
        end
        cd('../../');
...
for i=1:no_locs
    ...
    for p = 1:length(params)
        ...
        % do statistics
        if p==1 || p==3
            m_scatter(wave_struct,mwd_struct,'di',[0 0.5 1:5 8:10]);
        elseif p==2
            m_scatter(wave_struct,mwd_struct,'di',[0 0.1 1:6]);
        elseif p==3
            m_scatter(wave_struct,mwd_struct,'di',[0 0.1 1 5 6:12]);
