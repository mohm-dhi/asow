...
for i = 1:length(cfsr_names)-1
    ...
    % save struct
    save(['hub_wind_sd\power\' name '_WindSpd_Hub.mat'],'WindSpd_Hub');
    save(['hub_wind_sd\power\' name '_WindDir_Hub.mat'],'WindDir_10m');
    save(['hub_wind_sd\power\' name '_WindSpd_10m.mat'],'WindSpd_10m');
    save(['hub_wind_sd\power\' name '_WindDir_10m.mat'],'WindDir_10m');
