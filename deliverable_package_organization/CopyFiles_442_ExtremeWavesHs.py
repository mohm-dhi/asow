...
dst = r'z:\04 Extreme\4.4 Waves\4.4.2 Significant Wave Height\P%d'
...
for part in ['Directional','Monthly Omnidirectional']:
    ...
    for k in range(1,8):
        ...
        src = r'\\USDEN1-STOR.DHI.DK\Projects\41806529\08_Results\_met_results\03 Extreme\3.4 Waves\3.4.2 Hsig\P%d\%s' % (k,part)
