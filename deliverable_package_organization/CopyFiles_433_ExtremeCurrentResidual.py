...
dst = r'z:\04 Extreme\4.3 Currents\4.3.3 Residual\P%d'
...
for d1,d2 in zip(depin,depou):
    ...
    for part in ['Directional','Monthly Omnidirectional']:
        ...
        for k in range(1,8):
            ...
            src = r'\\USDEN1-STOR.DHI.DK\Projects\41806529\08_Results\_met_results\03 Extreme\3.3 Currents\3.3.3 Residual\P%d\%s\%s' % (k,d1,part)
