...
dst = r'z:\04 Extreme\4.2 Water Levels\4.2.1 Total Water Level (Without Wave Crest)\P%d\%s'

for k in range(1,8):
    
    for part in ['HWL','LWL']:
    
        src = r'\\USDEN1-STOR.DHI.DK\Projects\41806529\08_Results\_met_results\03 Extreme\3.2 Water Levels\3.2.1 Total\P%d\%s' % (k, part)
