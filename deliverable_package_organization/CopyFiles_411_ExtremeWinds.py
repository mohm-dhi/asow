...
dst = r'z:\04 Extreme\4.1 Wind\4.1.1 10m MSL\P%d'

for k in range(1,8):
    
    for part in ['Directional','Monthly Omnidirectional','Peak Wind Rose']:
    
        src = r'\\USDEN1-STOR.DHI.DK\Projects\41806529\08_Results\_met_results\03 Extreme\3.1 Wind\3.1.1 10m MSL\P%d\%s' % (k, part)
