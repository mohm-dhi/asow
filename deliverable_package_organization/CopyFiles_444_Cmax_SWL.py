...
dst = r'z:\04 Extreme\4.4 Waves\4.4.4 Wave Crest Height\P%d'
...
for k in range(1,8):
    ...
    for src_file in glob.glob(os.path.join(src_k,'*SWL*.xlsx')):
    ...
    # list and copy files - tables
    for src_file in glob.glob(os.path.join(src_k,'*SWL*.jpg')):
